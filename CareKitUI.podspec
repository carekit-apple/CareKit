Pod::Spec.new do |s|
  ...
  # s.source                = { :git => 'https://github.com/HippocratesTech/otfcarekit.git', :branch => 'main', :tag => s.version.to_s}
  s.source 		= { :path => './' }

  s.source_files          = 'CareKitUI/CareKitUI/**/*.{swift}'
  #s.resources             = ['CareKitUI/CareKitUI/Supporting Files/Localization/*.lproj']
  s.exclude_files         = 'CareKitUI/CareKitUI/**/*.plist', 'CareKitUI/CareKitUITests/'
