...
- (void)generateTreatments {
    ...
    {
        OCKCareSchedule *schedule = [OCKCareSchedule weeklyScheduleWithStartDate:startDate occurrencesOnEachDay:@[@4,@2,@4,@4,@4,@0,@0]];
    ...
    {
        OCKCareSchedule *schedule = [OCKCareSchedule weeklyScheduleWithStartDate:startDate occurrencesOnEachDay:@[@0,@0,@0,@0,@0,@0,@4]];
        UIColor *color = OCKBlueColor();
    ...
    {
        OCKCareSchedule *schedule = [OCKCareSchedule weeklyScheduleWithStartDate:startDate occurrencesOnEachDay:@[@0,@0,@0,@0,@0,@0,@2]];
        UIColor *color = OCKPurpleColor();
...
- (void)generateEvaluations {
    ...
    {
        OCKCareSchedule *schedule = [OCKCareSchedule weeklyScheduleWithStartDate:startDate occurrencesOnEachDay:@[@1,@1,@1,@1,@1,@1,@0]];
        UIColor *color = OCKPurpleColor();
    ...
    {
        OCKCareSchedule *schedule = [OCKCareSchedule weeklyScheduleWithStartDate:startDate occurrencesOnEachDay:@[@1,@1,@1,@0,@1,@1,@0]];
        UIColor *color = OCKBlueColor();
